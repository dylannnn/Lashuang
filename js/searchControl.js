...
app.controller('searchCtrl',function ($scope, $http) {
	...
	var scriptHandler = {
		...
		pageload : function () {
			...
			scriptHandler.requiredFunc();
		
			// #1 - Show Search Input Value
			scriptHandler.showSearchInputVal();
			
			// #2 - Check if open the site on Mobile or not
			scriptHandler.isMobile();
			scriptHandler.progressBar();
		}
	};
	
	scriptHandler.pageload();
