...
app.config(['$routeProvider', function ($routeProvider) {
    $routeProvider.
        ...
        when('/dict', {
            templateUrl: 'views/dictContent.html',
            controller:'mainSearch'
        }).
        when('/about', {
...
app.factory('pageLoad', function($firebase, $rootScope, $routeParams, $location, FIREBASE_URL) {
    ...
    //Temporary object
    var initialSetup = {
        pageLoadFunc : function () {
            console.log("IniFunc Success");
        ...
        iniFunc : function () {
            initialSetup.pageLoadFunc();
            initialSetup.getBrowser();
            initialSetup.isMobile();
        },
